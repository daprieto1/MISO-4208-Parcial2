...
cucumber features/createFuelType.feature:3 # Scenario: Create Car first time
cucumber features/createFuelType.feature:23 # Scenario Outline: Create Fuel Type, Examples (#1)
cucumber features/createReminder.feature:3 # Scenario: Create Car first time
cucumber features/createReminder.feature:36 # Scenario Outline: Create Reminder, Examples (#1)
```
